...
namespace SuperScrollView
{
    ...
    public class LoopGridView : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        */
        ...
        /// <param name="onGetItemByRowColumn">初始化</param>
        /// <param name="resetPos">重置</param>
        public void ReloadData(int itemCount, System.Func<LoopGridView, int, int, int, LoopGridViewItem> onGetItemByRowColumn, bool resetPos = true)
        {
            if (_IsInited)
            {
                // 刷新
            ...
            else
            {
                // 初始化
                _IsInited = true;
                InitGridView(itemCount, onGetItemByRowColumn);
            }
        }
