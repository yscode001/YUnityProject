    ...
    */
    ...
    public class LoopStaggeredGridView : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        */
        ...
        /// <param name="layoutParam">初始化</param>
        /// <param name="onGetItemByItemIndex">初始化</param>
        /// <param name="resetPos">重置</param>
        public void ReloadData(int itemCount, GridViewLayoutParam layoutParam,
            System.Func<LoopStaggeredGridView, int, LoopStaggeredGridViewItem> onGetItemByItemIndex, bool resetPos = true)
        {
            if (_IsInited)
            {
                // 刷新
                SetListItemCount(itemCount, resetPos);
                RefreshAllShownItem();
                /*
            ...
            else
            {
                // 初始化
                _IsInited = true;
                InitListView(itemCount, layoutParam, onGetItemByItemIndex);
            }
        }
