...
namespace SuperScrollView
{
    ...
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        */
        ...
        /// <param name="onGetItemByIndex">初始化</param>
        /// <param name="resetPos">重置</param>
        public void ReloadData(int itemCount, System.Func<LoopListView2, int, LoopListViewItem2> onGetItemByIndex, bool resetPos = true)
        {
            if (_IsInited)
            {
                // 刷新
            ...
            else
            {
                // 初始化
                _IsInited = true;
                InitListView(itemCount, onGetItemByIndex);
            }
        }
