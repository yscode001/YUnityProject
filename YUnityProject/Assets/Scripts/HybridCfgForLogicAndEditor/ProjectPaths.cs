...
public static partial class ProjectPaths
{
    public static class Hybrid
    {
        ...
        public const string CfgForLogicAndEditor = "CfgForLogicAndEditor";
        public static readonly string CfgForLogicAndEditorFullPath = Path.Combine(CLRDir, $"{CfgForLogicAndEditor}.dll.bytes");

        public const string ProjectUtil = "ProjectUtil";
        public static readonly string ProjectUtilFullPath = Path.Combine(CLRDir, $"{ProjectUtil}.dll.bytes");
